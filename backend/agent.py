...
# 🤖 Language model - MODIFIED TO USE GEMINI
llm = ChatGoogleGenerativeAI(model="gemini-1.5-flash", temperature=0) # Consider "gemini-1.5-pro" for higher quality
...
# This class name is a bit misleading when using Gemini, but LangChain's abstraction handles it.
